...
<head>
    ...
    <script language="javascript" src="../style/js/jquery-1.4.2.js"></script>
	<script language="javascript" src="../style/js/jquery-ztree-2.5.js"></script>
	...
	<script language="javascript" src="../style/js/privilegeData.js" charset="utf-8"></script>
	<script language="javascript" src="../style/js/privilegeTree.js" charset="utf-8"></script>
...
<div id="MainArea">
    ...
    <div class="ItemBlock_Title1" id="userTitle" style="display: none;"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="../style/blue/images/item_point.gif"/>用户:ww
    ...
    <div class="ItemBlock_Title1" id="privilegeTitle" style="display: none;"><div class="ItemBlock_Title1">
        ...
        <div id="InputDetailBar">
            <image onclick="savePrivilege()" src="../style/images/save.png"/>
        </div>
</div>
